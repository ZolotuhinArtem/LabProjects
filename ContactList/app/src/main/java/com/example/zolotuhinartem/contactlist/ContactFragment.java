...
public class ContactFragment extends Fragment implements ContactOnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        doViewCreated(NUMBERS_KEY, R.id.rv_fragment_contacts_list, view, savedInstanceState, true);
    ...
    protected void doViewCreated(String dataArrayName, int listId, View view, @Nullable Bundle savedInstanceState, boolean isGenerateList) {
        ...
        if (activity != null) {
            SharedPreferences sharedPreferences = activity.getSharedPreferences(NUMBER_LIST_KEY, Context.MODE_PRIVATE);
